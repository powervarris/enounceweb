    ...
    <div class="main-container">
      <div class="sub-container">
        ...
        <div class="nav">
          ...
          <div class="nav-item active"><a href="{{ route('privacy') }}">Privacy Policy</a></div>
        ...
        <div class="policy-container">
          <div class="border">
            <p class= "policy-title">TERMS AND CONDITIONS</p>
            <p class="policy-text">  The standard Lorem Ipsum passage, used since the 1500s
